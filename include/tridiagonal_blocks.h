...
void solve_Dyy_tridiag_blocks(DTYPE *Zeta_next_component, DTYPE *rhs, DTYPE *Gamma, 
                            VelocityField u_BC, Boolean same_direction);

/* Solves the block diagonal system (I - ∂zz)u = f. */
void solve_Dzz_tridiag_blocks(DTYPE *U_next_component, DTYPE *rhs, DTYPE *Gamma,
                            VelocityField u_BC, Boolean same_direction);
#endif
